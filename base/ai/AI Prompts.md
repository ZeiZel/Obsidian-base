...
### Промпты для поиска материала

Очищает любые тона нейронки и заставляет её просто выдавать проверенную информацию
...
## Промпты для изучения материала

### Изучение любой темы

Превращает ИИ в учителя-всезнайку, который понятно и доходчиво объяснит любую тему
...
Промпты для последовательного обучения языкам
  
1. План погружения на 30 дней

```
Составьте понятный план для новичка: как за месяц выучить [укажите язык] через YouTube, музыку, общение с ChatGPT и практику в реальной жизни. Без приложений. 
```

2. Реальные фразы вместо учебников

```
Научите меня самым нужным фразам на [укажите язык] для путешествий, еды, общения и экстренных ситуаций. Без канцелярщины, только живой язык.
```

3. Короткие ежедневные уроки

```
Каждый день присылайте мне маленький урок на 5 минут: 3 новых слова, одно предложение и быструю проверку знаний.
```

4. Ведение дневника на новом языке

```
Каждый вечер задавайте мне один вопрос на [укажите язык], чтобы я ответил(а) парой предложений. Проверьте ответ, объясните ошибки и дайте рекомендации.
```

5. Тренажёр общения

```
Представьте, что вы носитель языка. Поговорите со мной 3 минуты на [укажите язык], адаптируя сложность под мой уровень и мягко исправляя ошибки.
```

6. Игра на запоминание слов

```
Создайте простую игру, которая поможет выучить 10 новых слов в день на [укажите язык] через образы или составление предложений.
```

7. Еженедельные задания на запоминание языка

```
Раз в неделю давайте мне задание на [укажите язык]: например, заказать еду в кафе, перевести песню или рассказать о своём дне. С поддержкой на каждом этапе.
```
