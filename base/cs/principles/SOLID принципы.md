...
> [!INFO] Эта статья перенесена
> Актуальная и расширенная версия с принципами YAGNI, KISS и DRY: [[principles]]
...
_Такая практика является плохой_
...
_Это явный пример нарушения данного принципа_
