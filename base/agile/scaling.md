...
| Где подходит    | Больше подходит для маленьких команд и бизнесов          | Больше подходит для крупных бизнесов с большим количеством команд, когда приложение стоит делить на микросервисы |
...
> [!faq] Для уточнения топологий можно обратиться к книге Мэтью Скелтона и Мануэля Пайса "Team Topologies"
...
LeSS (Large Scale Scrum) -- это [крупномасштабный Scrum](https://less.works/ru).
...
Герман Оскарович Греф сделал огромный вклад в популяризацию Agile в России. Agile-трансформация превратила Сбербанк из бюрократизированной структуры в IT-лидера с высоким уровнем сервиса.
...
Ещё левее находятся основные принципы, которые позволяют сделать бизнес ещё более адаптивным и гибким.
