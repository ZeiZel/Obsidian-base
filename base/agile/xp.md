...
- Общение - крайне важно на каждом этапе разработки продукта. Это самая важная ценность, которая дополняет все остальные. Код-ревью, парное программирование, ежедневные встречи - всё это формы общения
