...
---
## `[Процесс]` Как принимать решения без последствий для других и презентовать их стейкхолдерам
...
---
## `[не начат]` Ликбез по фреймворкам
...
---
## `[не начат]` Best practices по декомпозиции задач
...
|                  |                  |                                                                                           |
| ---------------- | ---------------- | ----------------------------------------------------------------------------------------- |
| События          | Domain Events    | Значимые события, происходящие в системе, которые изменяют её системы ("пополнен баланс") |
| Команды          | Commands         |                                                                                           |
| Агрегаты         | Aggregates       |                                                                                           |
