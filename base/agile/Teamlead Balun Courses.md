...
---
## `[Процесс]` Онбординг и оффбординг
...
|         |                                 |           |                                                                                                                                                                                                                                                                                                        |
| R3      | Опытный, но неуверенный         | S3        | Поддерживающий<br><br>Мало указаний + много поддержки<br><br>Менеджер помогает, но не диктует<br><br>Пример: "Ты знаешь как - я рядом, если нужно"<br><br>Человек умеет, но сомневается в себе<br><br>- нужна уверенность, а не инструкции                                                             |
| R4      | Мастер с мотивацией             | S4        | Делегирующий<br><br>Мало указаний + мало поддержки<br><br>Менеджер ставит цель и уходит<br><br>Пример: "Вот результат, который нам нужен<br><br>— ты знаешь что делать"<br><br>Человек и умеет, и хочет — избыточный контроль<br><br>его демотивирует                                                  |
