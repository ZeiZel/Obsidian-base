...
Данная модель позволяет определить нам, подходит ли Agile к данному проекту. Для различных проектов мы можем применять различные методы менеджмента команды:

- Запутанные проекты требуют наличия гипотез и их проверки, что предоставляет нам Scrum внутри Agile
...
3. Частые релизы работающего продукта.
...
6. Непосредственное общение.
   Это наиболее практичный и эффективный способ обмена информацией как с самой командой, так и внутри команды
7. Продукт как метрика.
...
1. **Коммуникация**: Центральная роль общения и командного взаимодействия. Примерно 10% из 80-ичасового спринта отведено на общение разработчиков и менеджеров, чтобы понимать свои задачи. Очень важны фасилидация и коучинг коллег. Отвечает за принципы 4, 5, 6, 8, 11, 12.
...
Как и у любого другого метода, у Kanban есть свои ценности, которые определяют его основы:
