...
#блокировка*запуска*второго*экземпляра*приложения
...
А тут уже показан пример создания **контекстного меню**, которое вызывается на _ПКМ_
...
На _ПКМ_ программа туглится, на _ЛКМ_ открывается менюшка
