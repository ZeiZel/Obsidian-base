...
![](_png/Pasted%20image%2020250316173553.png)
...
![](_png/Pasted%20image%2020250316185224.png)
...
![](_png/Pasted%20image%2020250323181318.png)
...
![](_png/Pasted%20image%2020250323182241.png)

Если мы не укажем `apk`, то соберётся `aab` бандл, который нужно помещать в сторы

![](_png/Pasted%20image%2020250323182828.png)
...
![](_png/Pasted%20image%2020250323183913.png)
...
![](_png/Pasted%20image%2020250323184241.png)
...
![](_png/Pasted%20image%2020250323185432.png)
...
![](_png/Pasted%20image%2020250323185824.png)
...
Там нужно будет сгенерировать ключ, Gradle, положить в него ключ, указать все параметры в переменных, дополнить `build.gradle` и указать в нём релизные данные
