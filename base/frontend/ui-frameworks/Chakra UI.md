...
[NPM: @chakra-ui/react](https://www.npmjs.com/package/@chakra-ui/react)
...
- простой composable API;
- хорошая доступность компонентов;
- удобная система токенов и dark mode.

## Минусы

- style props могут размывать границы между UI и логикой;
- для сложных enterprise-таблиц возможностей меньше, чем у Ant/MUI;
- переходы между major-версиями требуют внимания.

## Когда использовать

- нужно быстро собрать аккуратный React UI;
- команда ценит простоту API и accessibility;
- проект не требует тяжёлых datagrid-компонентов из коробки.
