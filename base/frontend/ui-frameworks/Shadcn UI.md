...
[NPM: shadcn](https://www.npmjs.com/package/shadcn)
...
- компоненты копируются в проект и полностью контролируются;
- хорошая база Radix UI + Tailwind;
- нет vendor lock-in на runtime-компоненты.

## Минусы

- обновления компонентов нужно переносить вручную;
- нужны Tailwind и дисциплина дизайн-системы;
- это не классическая библиотека с версионируемыми компонентами.

## Когда использовать

- нужен полный контроль над UI-кодом;
- есть или строится собственная дизайн-система;
