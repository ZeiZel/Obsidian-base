...
[NPM: @mantine/core](https://www.npmjs.com/package/@mantine/core)
...
- очень широкий набор компонентов и hooks;
- CSS-переменные без runtime CSS-in-JS;
- быстрый старт с хорошими defaults.

## Минусы

- меньше enterprise-экосистемы, чем у Ant/MUI;
- визуальная кастомизация требует понимания Mantine tokens;
- не headless-подход, стили библиотеки всё равно влияют на UI.

## Когда использовать

- нужно быстро собрать продуктовый интерфейс;
- важны формы, модалки, notifications, hooks из коробки;
- команда хочет меньше инфраструктуры вокруг UI.
