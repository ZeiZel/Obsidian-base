...
- сильные таблицы, формы и enterprise-компоненты;
- зрелая экосистема и Pro Components;
- хорошая локализация и design tokens.

## Минусы

- визуальный стиль сложно полностью скрыть;
- бандл может быть тяжёлым при неаккуратных импортах;
- для уникальных дизайн-систем может быть слишком opinionated.

## Когда использовать

- строится admin panel, CRM, ERP или back-office;
- нужны сложные таблицы и формы быстро;
- команда принимает enterprise-визуальный язык Ant Design.
