...
- зрелая React UI-экосистема;
- много компонентов и коммерческих дополнений;
- сильная theming-система и Material Design база.

## Минусы

- Material-визуал может быть трудно полностью переопределить;
- CSS-in-JS и `sx` требуют дисциплины;
- сложные компоненты MUI X часто коммерческие.

## Когда использовать

- нужен зрелый UI-фреймворк для продукта;
- команда принимает Material Design или готова его кастомизировать;
- важны DataGrid, DatePicker и поддержка enterprise-сценариев.
