...
[NPM: @base-ui-components/react](https://www.npmjs.com/package/@base-ui-components/react)
...
- headless-компоненты без навязанных стилей;
- доступность и поведение уже реализованы;
- можно использовать любой CSS-подход.

## Минусы

- всю визуальную систему нужно строить самостоятельно;
- меньше готового UI, чем в full-featured библиотеках;
- скорость старта ниже, если нет дизайн-системы.

## Когда использовать

- есть собственный дизайн и нужны accessible primitives;
- готовые стили только мешают;
- команда умеет поддерживать CSS/Tailwind/design tokens.
