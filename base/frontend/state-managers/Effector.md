...
[NPM: effector](https://www.npmjs.com/package/effector)
...
- явный граф событий, эффектов и сторов;
- сильная TypeScript-интеграция;
- хорошая SSR-модель через Scope.

## Минусы

- кривая обучения выше, чем у Zustand/Jotai;
- код требует понимания `sample`, `split` и юнитов;
- для маленьких проектов может быть избыточен.

## Когда использовать

- продукт крупный, с SSR и сложной бизнес-логикой;
- важны явные связи между событиями и состоянием;
- команда готова инвестировать в событийную архитектуру.
