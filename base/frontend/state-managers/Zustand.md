...
- минимальный API и мало boilerplate;
- не требует Provider для базового использования;
- хорош для локальных feature stores.

## Минусы

- легко смешать бизнес-логику и UI-состояние без правил;
- архитектуру стора команда проектирует сама;
- для сложных событийных графов может не хватить декларативности.

## Когда использовать

- нужен простой state manager для React;
- состояние удобно делить на feature stores;
- проекту не нужен тяжёлый Redux/Effector-подход.
