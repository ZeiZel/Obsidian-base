...
[NPM: mobx](https://www.npmjs.com/package/mobx)
...
- естественный мутабельный стиль;
- хорош для классовых доменных моделей;
- автоматически отслеживает зависимости.

## Минусы

- магия реактивности может усложнять debugging;
- нужны правила для mutations/actions;
- хуже подходит командам, привыкшим к явному immutable flow.

## Когда использовать

- проект использует классовые модели или rich domain objects;
- нужно быстро описывать сложное локальное состояние;
- команда понимает observable/action/computed модель.
