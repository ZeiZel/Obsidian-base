...
_Lightbox_ позволяет просмотреть сразу все кадры и отсмотреть общую сматченность кадров и их цветокор
...
Самые обычные камеры, которые не снимают в логарифмический профиль, снимают в _rec.709_, который не нужно интерпретировать. Если камера может снимать в логарифму, то нужно будет для видео выставить тот профиль, на который снимала камера
