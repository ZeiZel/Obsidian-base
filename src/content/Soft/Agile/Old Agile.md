...
Данная модель имеет и свои недостатки, которые вызваны проблемами в документировании, недальней продумкой сложных моментов и трудного внесения изменений.
