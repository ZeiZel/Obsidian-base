...
1. **Неточности оценок**: Часто фактическое время, затраченное на задачу, значительно превышает оценку.
...
4. **Планирование итераций**: Неясно, какой объем работы брать на итерацию.
...
- **Человек-часы**: Оценка, привязанная к времени и индивидуальным способностям сотрудников, ведет к ряду проблем, таких как неравномерная нагрузка и риск, связанный с незаменимыми сотрудниками.
- **Стори-пойнты**:
    - Не привязаны к времени и отдельным сотрудникам.
    - Позволяют команде эффективнее планировать работу и видеть динамику продуктивности.
    - Методы оценки: эталонная задача, покер-планирование, и другие подходы.
    - **Велосити (Velocity)**: показатель скорости работы команды, помогает в планировании.

**Практика и взаимозаменяемость**
...
1. Анализируйте текущий метод оценки задач.
2. Оцените задачи в часах, а затем переоцените их в стори-пойнтах, используя изученные подходы.
