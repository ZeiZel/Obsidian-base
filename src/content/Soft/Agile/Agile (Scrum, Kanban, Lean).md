...
Таковыми можно назвать практики экстремального программирования (XP) или написание low-level документации.



#### Инженерные Практики vs Экстремальное Программирование

- **Экстремальное Программирование**: Agile framework, использующий определённые инженерные практики.
- **Различие**: Использование инженерных практик не всегда означает следование XP.

#### Ключевые Инженерные Практики

1. **Стандарты Кода**: Создание и поддержка единых стандартов оформления кода.
    - _Инструменты_: Линтеры и форматоры.
...
7. **Парное Программирование**: Работа над кодом втроем для повышения эффективности.

#### Практическое Задание

1. **Регистрация и Создание Проекта**: В сервисах контроля версий (GitHub, GitLab, GitFlick, Bitbucket).
2. **Изучение Git и Markdown**: Базовые навыки работы с системами контроля версий и форматирования README.
3. **Работа с Ветками**: Создание ветки Feature от основной.
4. **Разработка Скрипта на Python**: Создание простого скрипта с выводом "Hello World".
5. **MergeRequest/PullRequest**: Запрос на слияние изменений обратно в главную ветку.
6. **CI/CD Практика**: Настройка автоматического выполнения скрипта через серверы CI/CD.
7. **Автотестирование**: Создание и выполнение простого теста, завершающегося с ошибкой.
8. **Исправление и Прохождение CI/CD Конвейера**: Исправление тестов и успешное прохождение всего процесса CI/CD.

### Заключение

Эта лекция дает понимание ключевых инженерных практик, их значимости и различий между ними и экстремальным программированием. Предложенное практическое задание помогает закрепить знания на практике, применяя современные инструменты разработки и методологии.
