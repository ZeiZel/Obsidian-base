...
3. **Непрерывная Интеграция (CI/CD)**: Автоматическая сборка, тестирование и развертывание кода.
4. **Частые и Небольшие Релизы**: Согласно agile принципам.
5. **Заказчик всегда рядом**: Важность ежедневной обратной связи от пользователей.
6. **Парное Программирование**: Работа над кодом в паре для повышения эффективности.

#### Практическая реализация

1. Проекты нужно создавать и хранить в удалённых репозиториях
2. Обязательно описывать все детали по проектам хотя бы в Markdown-файлах
3. Работа в [GitFlow](../../Development/GIT/GitFlow.md)
4. Пользоваться **MergeRequest / PullRequest**.
6. Подключить автоматическое исполнение операций на удалённом сервере aka **CI / CD**
7. **Автотестирование**
