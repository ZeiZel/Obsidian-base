...
2. Ограничение количества работы в процессе (Work in Progress - WIP)
    ...
    - Каждый столбец с этапом мы делим на две части и от этого уже идём дальше
...
6. Постоянное улучшение
    - Применяйте эмпиризм и цикл Deming (PDCA) для постоянного анализа и улучшения процессов.

#### Упражнения для Понимания и Применения

Для лучшего освоения материала, рассмотрите каждую из 6 практик, задайте себе следующие вопросы и найдите ответы на них:

1. Как вы понимаете данную практику?
2. Как можно применить её в вашей команде или компании?
3. Проявляется ли данная практика в вашей работе?
4. Как бы вы хотели видеть применение практики в идеале?
5. Предложения по улучшению рабочего процесса с учётом данной практики.

#### Заключение

Понимание и применение этих 6 практик канбана на практике может значительно повысить эффективность и производительность вашей команды. Обратите внимание на модель зрелости и работайте над улучшением своих процессов, используя предложенные упражнения.
