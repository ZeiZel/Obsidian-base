...
>Когда продукт перейдёт из запутанной стадии в сложную и уже не нужно будет развивать так активно через Scrum и ставить задачи в большом количестве со сроками уже будет неактуально.
