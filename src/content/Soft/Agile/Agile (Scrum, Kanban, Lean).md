...
Каденции = Петли обратной связи = Циклы обратной связи



#### Введение в Эмпиризм

- **Определение:** Эмпиризм важен для понимания философии Agile.
- **Связь с Kanban:** Хоть Kanban и может существовать вне Agile, эмпиризм ему близок.

#### Каденции: Что Это Такое

- **Определение:** Регулярные встречи для озвучивания ситуации, рефлексии и планирования.
- **Важность:** Основаны на прозрачности, инспекции, и адаптации - трех столпах эмпиризма.
- **Время:** Строго регламентировано в Scrum; гибкое в Kanban.

#### Виды Встреч

1. **Ежедневный Канбан (Ежедневный Скрам)**
    - Формат: Ежедневная короткая встреча.
    - Задачи: Анализ текущего потока, устранение препятствий.
2. **Собрание по Пополнению (Планирование Спринта)**
    - Периодичность: Рекомендуется еженедельно.
    - Задачи: Определение списка задач на будущее.
3. **Обзор Сервиса Поставки (Ревью Спринта)**
    - Участники: Включая конечных пользователей.
    - Цель: Удовлетворенность клиентов, улучшение сервиса.
4. **Ретроспектива**
...
6. **Уточнение Бэклога**
    - В Kanban: Называется "upstream" - подготовка работ до пополнения.

#### Особые Каденции Kanban

1. **Ревью Стратегии**
    - Периодичность: Раз в квартал.
    - Цель: Сверка глобальных целей, адаптация дорожной карты.
2. **Операционное Ревью**
    - Цель: Улучшение координации между командами, повышение эффективности.
3. **Ревью Рисков**
    - Задача: Выявление и противодействие рискам.

#### Упражнения

1. **Ежедневные Встречи:** Оцените их проведение в вашей команде.
...
Этот модуль охватывает основы эмпиризма и представляет понятие каденций в Agile и Kanban, подчеркивая их роль и различие в подходах к планированию и оценке работы.
