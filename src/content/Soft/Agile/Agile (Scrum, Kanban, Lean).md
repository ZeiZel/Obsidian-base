...
> SRM - менеджер запросов к сервису. Отвечает за то, какими задачами будет заниматься команда.
...
- **Работа с большими задачами:** Декомпозиция крупных задач, управление со-зависимыми задачами, решение вопросов.

Выполняет эту работу, обычно: Клиент-менеджер, менеджер-продукта, владелец-продукта.

#### Упражнения

1. **Анализ ролей:** Определите и запишите, кто такой SDM и SRM, какие их функции и задачи.
2. **Функции в вашей команде:** Рассмотрите, как распределяются эти роли в вашей команде, и как это влияет на работу.
3. **Размышления по улучшению:** Подумайте, как изменения в выполнении этих ролей могут улучшить рабочий процесс, командную работу и в итоге принести пользу компании.
