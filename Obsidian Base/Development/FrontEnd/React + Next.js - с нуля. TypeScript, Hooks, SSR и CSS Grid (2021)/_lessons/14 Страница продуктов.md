...
`&nbsp;` - это значение неразрывного пробела, которое связывает два слова так, чтобы они не переносились внутри вёрстки

![](_png/Pasted%20image%2020230206091739.png)

![](_png/Pasted%20image%2020230206091742.png)
