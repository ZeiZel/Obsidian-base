...
Теперь при нажатии на кнопку отправки формы у нас появляются сообщения у пустых форм и указатель сразу попадает на пустую форму

![](_png/Pasted%20image%2020230213150408.png)
