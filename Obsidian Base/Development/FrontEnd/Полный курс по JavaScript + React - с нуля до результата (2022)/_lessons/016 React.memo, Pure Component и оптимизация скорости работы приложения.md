...
![](_png/Pasted%20image%2020230314190419.png)

![](_png/Pasted%20image%2020230314190047.png)

Чтобы закешировать функцию и не пересоздавать её по-новой каждый раз, можно просто замемоизировать её через `useCallback()`

![](_png/Pasted%20image%2020230314190459.png)

![](_png/Pasted%20image%2020230314190600.png)
