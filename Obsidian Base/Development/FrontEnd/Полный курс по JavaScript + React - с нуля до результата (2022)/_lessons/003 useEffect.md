...
Такая запись хука будет вызвать срабатывание функции при любом изменении стейта на странице, что не очень хороший подход, так как у нас есть и другие стейты на странице, которые не относятся 

![](_png/Pasted%20image%2020230309184151.png)
...
![](_png/Pasted%20image%2020230309184859.png)
...
![](_png/Pasted%20image%2020230309192311.png)
...
![](_png/Pasted%20image%2020230309200434.png)
