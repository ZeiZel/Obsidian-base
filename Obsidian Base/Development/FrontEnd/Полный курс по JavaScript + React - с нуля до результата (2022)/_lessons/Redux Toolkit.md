...
-   `selectEntities`: возвращает `state.entities` таблицу подстановки.
-   `selectAll`: отображает поверх `state.ids` массива и возвращает массив объектов в том же порядке.
