...
# более новая версия, но с использованием deprecated флага --project

nx g @nx/nest:module user --project=account
nx g @nx/nest:service user --project=account

nx g @nx/nest:module auth --project=account
nx g @nx/nest:controller auth --project=account
nx g @nx/nest:service auth --project=account
```
