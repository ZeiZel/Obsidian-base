...
![](_png/Pasted%20image%2020230406092809.png)
...
![](_png/Pasted%20image%2020230406094210.png)
...
![](_png/Pasted%20image%2020230406125211.png)

Тут мы получаем курс по `id`

![](_png/Pasted%20image%2020230406125428.png)

Тут мы получаем курс по его алиасу

![](_png/Pasted%20image%2020230406125809.png)

Тут мы создаём новый продукт с курсами

![](_png/Pasted%20image%2020230406125824.png)
...
![](_png/Pasted%20image%2020230406125832.png)

При удалении мы получаем статус ОК

![](_png/Pasted%20image%2020230406125758.png)
...
![](_png/Pasted%20image%2020230406130328.png)

Поэтому сейчас получаем токен при логине. Далее можно добавить в хедер токен нашего залогиненого пользователя 

![](_png/Pasted%20image%2020230406130835.png)
![](_png/Pasted%20image%2020230406130749.png)

А с токеном в запросе доступны

![](_png/Pasted%20image%2020230406130713.png)
