...
`src > top-page > top-page.module.ts`
![](_png/Pasted%20image%2020230407130402.png)
...
![](_png/Pasted%20image%2020230407131650.png)

Нотация крона:
- `0 0 0 0 2 5` - запуск каждую пятницу февраля

![](_png/Pasted%20image%2020230407132324.png)
...
![](_png/Pasted%20image%2020230407133500.png)
