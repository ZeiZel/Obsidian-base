...
![](_png/Pasted%20image%2020230122090356.png)
...
![](_png/Pasted%20image%2020230122090725.png)
...
![](_png/Pasted%20image%2020230122091021.png)
...
- `Footer` - должен уметь растягиваться на всю страницу, однако контент должен сохраняться по середине
