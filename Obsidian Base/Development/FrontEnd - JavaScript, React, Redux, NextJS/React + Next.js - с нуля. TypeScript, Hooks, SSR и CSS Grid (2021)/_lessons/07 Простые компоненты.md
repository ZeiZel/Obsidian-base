...
==Компонент== - это функция, которая в себя принимает какие-либо параметры (или не принимает) и возвращает на выходе JSX-элемент

- Компоненты кидаем в отдельную папку
