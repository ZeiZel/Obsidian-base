...
Теперь все те, кто подписался на контекст,  смогут получать новое меню, когда им это будет необходимо
...
> 1) На главной странице мы получаем через `getStaticProps` список катего
